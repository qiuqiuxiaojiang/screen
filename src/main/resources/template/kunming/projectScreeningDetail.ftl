...
<chapter name="昆明市盘龙区社区三高慢病防控项目筛查报告" id="projectScreening" fontName="simsun" fontSize="1" color="255,255,255" spacingAfter="10" >
	<text indent= "0" align="center" fontName="simsun" fontSize="15"  style="bold" spacing="10">
		昆明市盘龙区社区三高慢病防控项目筛查报告
	</text>
	...
	<table cols="2.6,1.8,1.3,1.6,0.5,1.2,1.6,0.5,3.5,3.5" borderColor="${colorWords}" spacing="5">
		...
		<row>
			...
			<cell  align="center"  border="1">
				<#if geneReports?? && geneReports?contains('糖尿病用药套餐或糖尿病基因检测4项')>

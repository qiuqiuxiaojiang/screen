...
<chapter name="昆明市盘龙区社区三高慢病健康管理项目筛查报告" id="projectScreening" fontName="simsun" fontSize="1" color="255,255,255" spacingAfter="1" >
	<text indent= "0" align="center" fontName="simsun" fontSize="15"  style="bold" spacing="1">
		昆明市盘龙区社区三高慢病健康管理项目筛查报告
	</text>
	...
	<table cols="2.6,1.8,1.3,1.6,0.5,1.2,1.6,0.5,3.5,3.5" borderColor="${colorWords}" spacing="5">
		...
		<row>
			<cell padding="3" align="left"  fontName="simsun" fontSize="9" color="${colorWords}" style="bold" colspan="4" border="5">糖尿病用药套餐或糖尿病基因检测4项</cell>
			<cell  align="center"  border="1">
				<#if geneReportCs?? && geneReportCs?contains('糖尿病用药套餐或糖尿病基因检测4项')>
					<image   width="6" height="6">img/pdf/projectScreening/yes.png</image>
				<#else>
					<image   width="6" height="6">img/pdf/projectScreening/no.png</image>
				</#if>

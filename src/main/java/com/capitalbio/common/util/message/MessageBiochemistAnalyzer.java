...
/**
 * 为了居家检设备不用任何修改，则沿用之前的返回消息
 * 
 * @author wdong
 *
 */
@XmlRootElement
public class MessageBiochemistAnalyzer {
	//错误码，0:成功;1:错误
	public int code = 0;
	...
	public static MessageBiochemistAnalyzer error(String message) {
		MessageBiochemistAnalyzer m = new MessageBiochemistAnalyzer();
		m.setCode(1);
		m.setMessage(message);
		return m;
	}
	public static MessageBiochemistAnalyzer error(int errCode, String message) {
		MessageBiochemistAnalyzer m = new MessageBiochemistAnalyzer();
		m.setCode(errCode);
		m.setMessage(message);
		return m;
	...
	public static MessageBiochemistAnalyzer success() {
		return new MessageBiochemistAnalyzer();
	}
	
	public static MessageBiochemistAnalyzer data(String data) {
		MessageBiochemistAnalyzer m =  new MessageBiochemistAnalyzer();
		m.setData(data);
		return m;
	}
	
	public static MessageBiochemistAnalyzer dataMap(Map<String,Object> dataMap) {
		MessageBiochemistAnalyzer m =  new MessageBiochemistAnalyzer();
	...
	public static MessageBiochemistAnalyzer dataList(List<Map<String,Object>> dataList) {
		MessageBiochemistAnalyzer m =  new MessageBiochemistAnalyzer();

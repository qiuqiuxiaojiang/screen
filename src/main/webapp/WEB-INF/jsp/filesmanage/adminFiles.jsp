...
<head>
<title>个人健康档案</title>
 	<link rel="stylesheet" href="${ctx_static}/lightbox/lightbox.css">
 	<link rel="stylesheet" href="${ctx_static}/zyUpload/zyUpload.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/component.css"></link>
	<link rel="stylesheet" href="${ctx_static}/pagenation/pagenation.css">
...
<script type="text/javascript">
	$(function (){
		$("#mytable").createTable({
	        title:"模块列表",
	        url:"${ctx}/files/getAdminFilesList.json",
	        multiChecked:true,
	        hasRowNumber:true,
	        width:"auto",
	        params:{},
	        columns:[
	            ...
	            {field:'contentType',title:'缩略图',width:150,formatter:function(val,row){
					...
					}else if(val==".jpg" || val==".jpeg" || val ==".gif"||val==".bmp"||val==".png"){
					...
					$.ajax({
						...
						success:function(data){
							if(data.message=="success"){
								alert("删除成功！");
								window.location.href="${ctx}/files/admiFilesManage.htm";
							}else{
								alert("删除失败！");
							}
						}
		...
		<div class="row">
			<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 main'>
				<div class="table-assist" for="mytable"  style="text-align: right">
			        ...
			        <div class="btn-panel">
			            <input id="uploadBnt" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-sm btn-success" value="上传新文件" />
...
<script src="${ctx_static}/lightbox/lightbox-2.6.min.js"></script>
<script src="${ctx_static}/zyUpload/uploadinfo.js"></script>
<script src="${ctx_static}/zyUpload/zyFile.js"></script>
<script src="${ctx_static}/zyUpload/zyUpload.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/component.js"></script>
<script src="${ctx_static}/js/zyUpload-assist.js"></script>
<script src="${ctx_static}/pagenation/pagenation.js"></script>
</body>
</html>

...
<div class="main">
	<div class="tab">
        <ul>
            ...
            <a href="${ctx }/manage/hv/xyHealthDetailIndex.htm?district=${districtHc}"><li class="activeLi">血压筛查情况</li></a>
...
<script>
	$(function () {
		...
		/*血压情况人群分布*/
		$.ajax({
			url : "${ctx}/manage/hv/findBloodPressureConditionPeopleDistributionHealthCheck.json",
			data : {
				"district" : district
			},
			dataType : "json",
		...
		/*血压情况年龄分布*/
		$.ajax({
			url : "${ctx}/manage/hv/findBloodPressureConditionAgeDistributionHealthCheckDetail.json",
			data : {
				"district" : district
			},
			dataType : "json",
			success : function(o) {
				var data = o.dataMap.list;
				//var data1 = o.dataMap.hypertendion;
				var data2 = o.dataMap.preHypertendion;
				var data3 = o.dataMap.newHypertendion;
		...
		/* $("#xyGroupData").click(function(){
		     window.location.href = '${ctx}/hv/download/exportBloodPressureConditionPeopleDistributionHealthCheck.json?district='+district;
		});
		
		$("#xyAgeData").click(function(){
		     window.location.href = '${ctx}/hv/download/exportBloodPressureConditionAgeDistributionHealthCheckDetail.json?district='+district;
		}); */
		
		$("#xyGroupData").click(function(){
		     $.ajax({
		      	url:"${ctx}/hv/download/exportBloodPressureConditionPeopleDistributionHealthCheck.json",
		      	type:"POST",
		      	data : {
					"district" : district
				},
		...
		$("#xyAgeData").click(function(){
		     $.ajax({
		      	url:"${ctx}/hv/download/exportBloodPressureConditionAgeDistributionHealthCheckDetail.json",
		      	type:"POST",
		      	data : {
					"district" : district
				},

...
<div class="main">
	<div class="tab">
        <ul>
            ...
            <a href="${ctx }/manage/hv/xzIndex.htm?district=${districtHc}"><li class="activeLi">血脂筛查情况</li></a>
    ...
    <div class="chartDiv">
        ...
        <div id="xt_sex"></div>
        <div style="text-align: center;">
        	<input type="button" class="btn btn-success btn-sm" value="下载数据" id="xzGenderData" style="margin-top:35px;"/>
        </div>
    </div>
    <div class="chartDiv">
        <h1>血脂情况体质分布</h1>
        ...
        <div style="text-align: center;">
        	<input type="button" class="btn btn-success btn-sm" value="下载数据" id="xzTizhiData" style="margin-top:35px;"/>
        </div>
    </div>
</div>
...
<script>
	$(function () {
		...
		/*血脂情况人群分布*/
		$.ajax({
			url : "${ctx}/manage/hv/findBloodLipidPeopleDistribution.json",
			dataType : "json",
			data : {
				"district" : district
			},
		...
		/*血脂情况年龄分布*/
		$.ajax({
			url : "${ctx}/manage/hv/findBloodPressureByAge.json",
			dataType : "json",
			data : {
				"district" : district
			},
			success : function(o) {
				var data = o.dataMap.list;
				var data1 = o.dataMap.hyperlipemia;
				var data2 = o.dataMap.bloodLipidAbnormal;
		...
		/*血脂情况性别分布*/
		$.ajax({
			url : "${ctx}/manage/hv/findBloodLipidByGender.json",
			dataType : "json",
			data : {
				"district" : district
			},
		...
		/*血脂情况体质分布 */
		$.ajax({
			url : "${ctx}/manage/hv/findBloodLipidPeopleDistributionByTizhi.json",
			dataType : "json",
			data : {
				"district" : district
			},
		...
		/* $("#xzGroupData").click(function(){
		     window.location.href = '${ctx}/hv/download/exportBloodLipidPeopleDistribution.json?district='+district;
		});
		
		$("#xzAgeData").click(function(){
		     window.location.href = '${ctx}/hv/download/exportBloodLipidConditionAgeDistributionHeadthCheck2.json?district='+district;
		});
		
		$("#xzGenderData").click(function(){
		     window.location.href = '${ctx}/hv/download/exportBloodLipidConditionPeopleDistributionByGender.json?district='+district;
		});
		
		$("#xzTizhiData").click(function(){
		     window.location.href = '${ctx}/hv/download/exportBloodLipidPeopleDistributionByTizhi.json?district='+district;
		}); */
		
		$("#xzGroupData").click(function(){
		     $.ajax({
		      	url:"${ctx}/hv/download/exportBloodLipidPeopleDistribution.json",
		      	type:"POST",
		      	data : {
					"district" : district
				},
		...
		$("#xzAgeData").click(function(){
		     $.ajax({
		      	url:"${ctx}/hv/download/exportBloodLipidConditionAgeDistributionHeadthCheck2.json",
		      	type:"POST",
		      	data : {
					"district" : district
				},
		...
		$("#xzGenderData").click(function(){
		     $.ajax({
		      	url:"${ctx}/hv/download/exportBloodLipidConditionPeopleDistributionByGender.json",
		      	type:"POST",
		      	data : {
					"district" : district
				},
		...
		$("#xzTizhiData").click(function(){
		     $.ajax({
		      	url:"${ctx}/hv/download/exportBloodLipidPeopleDistributionByTizhi.json",
		      	type:"POST",
		      	data : {
					"district" : district
				},

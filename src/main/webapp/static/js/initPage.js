...
(function(window,undefined){
	...
	function initPage(id,option){
		...
		if(isJump){
			...
			input.style.outlineColor='#358DF1';
	...
	function changeColor(node){
		node.style.backgroundColor='#358DF1';
	}
	...
	function createPageList(curPage,totalPage,showCount){
		...
		for(i=0;i<lis.length;i++){
			...
			tempLi.childNodes[0].style.backgroundColor='#ffffff';
			tempLi.firstElementChild.style.color = '#333';
			if(tempLi.className == 'active'){
				tempLi.childNodes[0].style.backgroundColor = '#358DF1';

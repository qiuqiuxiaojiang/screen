...
public class HttpClientUtil {
    ...
    public static String  post1(String url,Map<String, Object> map,Map<String,String> mapHeader){
...
//				return JSONObject.parseObject(result);
     ...
     * @throws Exception
     */
    public static String get(String urlStr, Map<String, String> paramMap,Map<String,String> mapHeader) throws Exception{
     ...
     * @throws Exception 
     */
    public static String post(String urlStr, Map<String, String> paramMap,Map<String,String> mapHeader) throws Exception{
        HttpURLConnection conn = null;
